            ...
            html.Section(
                ...
                children=[
                    ...
                    html.P(["2020 has been a difficult year for the retail business and the second hand resale was no exception. "
                            ...
                            "Inversely as purchasable bulk inventory decreased year-over-year, the cost of purchasing and transporting these same goods increased. "
            ...
            html.Section(
                ...
                children=[
                    ...
                    html.P(["Caretag forecasts growth throughout 2021 with an increased consumer focus on difficult to find, low-production, pieces primarily from “Avante-Garde” designers (Rick Owens, Guidi, Carol Christian Poell, etc). "
                            "As “archive” buyers become more attuned to their own personal style many will begin to separate themselves from what they see as “archive beasts” and more mainstream “archive” consumers. "
                            "This sentiment has strongly proliferated through-out social media with instagram accounts such as", html.A('@GuidiCommunity', className="no-underline", href='https://www.instagram.com/p/guidi_community', style={'margin': '0.25rem', 'color': '#ffd11a'}), ",", html.A('@Geocasket', className="no-underline", href='https://www.instagram.com/geocasket/', style={'margin': '0.25rem', 'color': '#ffd11a'}), "and", html.A('@lucentement.', className="no-underline", href='https://www.instagram.com/@lucentement/', style={'margin': '0.25rem', 'color': '#ffd11a'}),
